	...
	a.fn.fullpage = function(c) {
		...
		function M() {
			if (!c.autoScrolling) {
				...
				if ((d = d[d.length - 1]) && !d.hasClass("active")) {
					D = !0;
		...
		function ga(b) {
			...
			if (!P(b.target)) {
				...
				var e = O(b);
				u || t || (d = Q(d), r = d.y, y = d.x, b.find(".fp-slides").length && Math.abs(z - y) > Math.abs(n - r) ? Math.abs(z - y) > a(window).width() / 100 * c.touchSensitivity && (z > y ? a.fn.fullpage.moveSlideRight() : a.fn.fullpage.moveSlideLeft()) : c.autoScrolling && Math.abs(n - r) > a(window).height() / 100 * c.touchSensitivity && (n > r ? x("down", e) : r > n && x("up", e)))
			}
		}
		function P(b, d) {
			d = d || 0;
		...
		function p(b, d, e) {
			...
			if ("undefined" !== typeof h) {
				...
				c.autoScrolling ? (f.top = -h, b = "." + U) : (f.scrollTop = h, b = "html, body");
				var q = function() {
				...
				c.css3 && c.autoScrolling ? (V("translate3d(0px, -" + h + "px, 0px)", !0), setTimeout(function() {
					q()
				}, c.scrollingSpeed)) : a(b).animate(f, c.scrollingSpeed, c.easing, function() {
					q()
				});
				v = g;
				c.autoScrolling && (F(g), G(g, l))
			}
		}
		function W() {
			if (!D) {
		...
		function q(b, d) {
			...
			c.css3 ? (e = "translate3d(-" + e.left + "px, 0px, 0px)", b.find(".fp-slidesContainer").toggleClass("fp-easing", 0 < c.scrollingSpeed).css(X(e)), setTimeout(function() {
				s()
		...
		function Y() {
			K ? "text" !== a(document.activeElement).attr("type") && a.fn.fullpage.reBuild(!0) : (clearTimeout(Z), Z = setTimeout(function() {
		...
		function aa(b) {
			b.addClass("fp-table").wrapInner('<div class="fp-tableCell" style="height:' + ba(b) + 'px;" />')
		}
		function ba(b) {
			var a = k;
		...
		function V(a, c) {
			g.toggleClass("fp-easing", c);
			g.css(X(a))
		}
		function J(b, c) {
			"undefined" === typeof c && (c = 0);
			var e = isNaN(b) ? a('[data-anchor="' + b + '"]') : a(".fp-section").eq(b - 1);
			b === v || e.hasClass("active") ? ca(e, c) : p(e, function() {
				ca(e, c)
			})
		}
		function ca(a, c) {
		...
		function s(a) {
			c.css3 ? V("translate3d(0px, -" + a + "px, 0px)", !1) : g.css("top", -a)
		}
		function X(a) {
			return {
				"-webkit-transform": a,
		...
		a.fn.fullpage.setAutoScrolling = function(b) {
			...
			c.autoScrolling ? (a("html, body").css({
				...
				"touch-action": "none"
			}), b.length && s(b.position().top)) : (a("html, body").css({
				overflow: "visible",
				height: "initial"
			}), g.css({
				"-ms-touch-action": "",
		...
		a.fn.fullpage.setMouseWheelScrolling = function(a) {
			a ? document.addEventListener ? (document.addEventListener("mousewheel", m, !1), document.addEventListener("wheel", m, !1)) : document.attachEvent("onmousewheel", m) : document.addEventListener ? (document.removeEventListener("mousewheel", m, !1), document.removeEventListener("wheel", m, !1)) : document.detachEvent("onmousewheel", m)
		};
		a.fn.fullpage.setAllowScrolling = function(b) {
			if (b) {
				if (a.fn.fullpage.setMouseWheelScrolling(!0), K || ea) MSPointer = da(), a(document).off("touchstart " + MSPointer.down).on("touchstart " + MSPointer.down, ha), a(document).off("touchmove " + MSPointer.move).on("touchmove " + MSPointer.move, ga)
			} else if (a.fn.fullpage.setMouseWheelScrolling(!1), K || ea) MSPointer = da(), a(document).off("touchstart " + MSPointer.down), a(document).off("touchmove " + MSPointer.move)
		};
		...
		a.fn.fullpage.moveTo = function(b, c) {
			...
			"undefined" !== typeof c ? J(b, c) : 0 < e.length && p(e)
		};
		...
		a.fn.fullpage.reBuild = function(b) {
			...
			a(".fp-section").each(function() {
				...
				c.verticalCentered && a(this).find(".fp-tableCell").css("height", ba(a(this)) + "px");
		...
		a(".fp-section").each(function(b) {
			...
			if (1 < f) {
				...
				e.each(function(b) {
					a(this).css("width", g + "%");
					c.verticalCentered && aa(a(this))
				});
				d = d.find(".fp-slide.active");
				0 == d.length ? e.eq(0).addClass("active") : H(d)
			} else c.verticalCentered && aa(a(this))
			...
			c.scrollOverflow ? ("complete" === document.readyState && L(), a(window).on("load", L)) : a.isFunction(c.afterRender) && c.afterRender.call(this);
		...
		a.fn.fullpage.destroy = function(b) {
			...
			a(window).off("scroll", M).off("hashchange", W).off("resize", Y);
